    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Surface(
            ...
            Row(modifier = Modifier.padding(12.dp), verticalAlignment = Alignment.CenterVertically) {
                Text(text = "🪙 Saldo Poin Anda: $memberXp XP", fontWeight = FontWeight.Bold, fontSize = 13.sp, color = DrgOnAmberContainer)
            }
        }
        ...
        if (rewards.isEmpty()) {
            EmptyStateOrganicGraphic(
                ...
                message = "Kupon servis dan oli gratis sedang disiapkan bersama bengkel rekanan resmi."
            )
        } else {
            LazyColumn(
