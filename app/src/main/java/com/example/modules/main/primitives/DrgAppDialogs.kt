...
fun DrgAppDialogs(
    ...
    if (showRoleSwitcher) {
        RoleSwitcherDialog(
            ...
            onDismiss = onDismissRoleSwitcher
        )
    }

    if (showEmergencyTrigger) {
        EmergencyTriggerDialog(
            onDismiss = onDismissEmergencyTrigger,
    ...
    if (showAddKasDialog) {
        AddTransactionDialog(
            onDismiss = onDismissAddKasDialog,
    ...
    if (showAwardPointDialog && selectedTargetForAward != null && currentMember != null) {
        AwardPointDialog(
            ...
            onDismiss = onDismissAwardPointDialog,
    ...
    if (showAddHazardDialog) {
        AddHazardDialog(
            onDismiss = onDismissAddHazardDialog,
    ...
    if (showNotifPrefDialog) {
        NotificationPreferencesDialog(
            ...
            onDismiss = onDismissNotifPrefDialog,
            onSave = {
